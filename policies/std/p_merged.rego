package  policyset_12345

# pol 1
Authorize1 = result1 { 
  # Match any of the Rules
  result1 := MatchAnyRule1
}
MatchAnyRule1() = {"action" : "deny", "rule" : "acaa81bc-b0af-43b6-b486-4ab7778d5f98" } {
MatchItemToExactFn1 := {
"exact" : {`1`, `2`}
}
...
Authorize2 = result2 { 
  # Match any of the Rules
  result2 := MatchAnyRule2
}
MatchAnyRule2() = {"action" : "deny", "rule" : "3e94ef55-8c87-4597-a9b5-5f50dd226bfd" } {
MatchIpPrefixFn2 := {
...
Authorize3 = result3 { 
  # Match any of the Rules
  result3 := MatchAnyRule3
}
MatchAnyRule3() = {"action" : "deny", "rule" : "a6ad88e3-8cf3-4e35-9491-a0ff894dc943" } {
...
Authorize4 = result4 { 
  # Match any of the Rules
  result4 := MatchAnyRule4
}
MatchAnyRule4() = {"action" : "deny", "rule" : "8f2017ce-f7ef-4956-9334-088e942b1048" } {
MatchItemToExactFn4 := {
...
Authorize5 = result5 { 
  # Match any of the Rules
  result5 := MatchAnyRule5
}
MatchAnyRule5() = {"action" : "deny", "rule" : "269c72e8-c99d-473f-84c3-340d1f972424" } {
